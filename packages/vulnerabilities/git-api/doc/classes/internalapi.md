...
*Defined in [packages/vulnerabilities/git-api/api.ts:4244](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L4244)*
...
*Defined in [packages/vulnerabilities/git-api/api.ts:4257](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L4257)*
...
*Defined in [packages/vulnerabilities/git-api/api.ts:4269](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L4269)*
...
*Defined in [packages/vulnerabilities/git-api/api.ts:4281](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L4281)*
