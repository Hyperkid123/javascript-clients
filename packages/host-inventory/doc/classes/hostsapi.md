...
*Defined in [packages/host-inventory/base.ts:49](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/host-inventory/base.ts#L49)*
...
*Defined in [packages/host-inventory/base.ts:51](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/host-inventory/base.ts#L51)*
...
*Defined in [packages/host-inventory/api.ts:2032](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/host-inventory/api.ts#L2032)*
...
*Defined in [packages/host-inventory/api.ts:2045](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/host-inventory/api.ts#L2045)*
...
*Defined in [packages/host-inventory/api.ts:2062](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/host-inventory/api.ts#L2062)*
...
*Defined in [packages/host-inventory/api.ts:2085](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/host-inventory/api.ts#L2085)*
...
*Defined in [packages/host-inventory/api.ts:2102](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/host-inventory/api.ts#L2102)*
...
*Defined in [packages/host-inventory/api.ts:2118](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/host-inventory/api.ts#L2118)*
...
*Defined in [packages/host-inventory/api.ts:2135](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/host-inventory/api.ts#L2135)*
...
*Defined in [packages/host-inventory/api.ts:2150](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/host-inventory/api.ts#L2150)*
...
*Defined in [packages/host-inventory/api.ts:2164](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/host-inventory/api.ts#L2164)*
...
*Defined in [packages/host-inventory/api.ts:2179](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/host-inventory/api.ts#L2179)*
