...
export const OrderProcessApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listOrderProcesses(limit?: number, offset?: number, filter?: object, sortBy?: string, options: any = {}): RequestArgs {
            const localVarPath = `/order_processes`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
...
export const OrderProcessApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listOrderProcesses(limit?: number, offset?: number, filter?: object, sortBy?: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrderProcessCollection> {
            const localVarAxiosArgs = OrderProcessApiAxiosParamCreator(configuration).listOrderProcesses(limit, offset, filter, sortBy, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const OrderProcessApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listOrderProcesses(limit?: number, offset?: number, filter?: object, sortBy?: string, options?: any): AxiosPromise<OrderProcessCollection> {
            return OrderProcessApiFp(configuration).listOrderProcesses(limit, offset, filter, sortBy, options)(axios, basePath);
        },
        /**
         * Removes the association to the product(s) defined in the \'before\' and/or \'after\' that would be executed when using this Order Process
         * @summary Removes the \'before\' and/or \'after\' product(s) for an Order Process
...
export class OrderProcessApi extends BaseAPI {
     ...
     * @memberof OrderProcessApi
     */
    public listOrderProcesses(limit?: number, offset?: number, filter?: object, sortBy?: string, options?: any) {
        return OrderProcessApiFp(this.configuration).listOrderProcesses(limit, offset, filter, sortBy, options)(this.axios, this.basePath);
    }
