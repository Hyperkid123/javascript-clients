...
*Defined in [packages/catalog/api.ts:1133](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/catalog/api.ts#L1133)*
...
*Defined in [packages/catalog/api.ts:1127](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/catalog/api.ts#L1127)*
