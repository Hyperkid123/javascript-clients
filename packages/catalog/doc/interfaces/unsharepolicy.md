...
*Defined in [packages/catalog/api.ts:1265](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/catalog/api.ts#L1265)*
...
*Defined in [packages/catalog/api.ts:1259](https://github.com/Hyperkid123/javascript-clients/blob/master/packages/catalog/api.ts#L1259)*
